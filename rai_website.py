...
class rai_website():
    ...
    def create_new_array(self):
        ...
        try:
            ...
            print(f"{settings[0]} = [")
            for i in range(new_array): print(new_array[i] + ", ")
            print("]")
...
# content_amazonsmp_seasons_details, 3, 4, [title, start, end, types]
# content_amazonsmp_seasons, 23, 9, [type, name, part, start, end, life, version, description, link]
