...
const DohstPage = {
    ...
    content: {
        ...
        'footer': `<br>
            <p>Website <a href="/updates.html">Version ${dohst23['version']}</a>
            - Written and Maintained by <!-- ///////// and --> <a href="${dohst23['link']}">Dohst</a></p>
            <p>Copyright &copy;<a href="${dohst23['link']}">Dohst</a> 2022-2026, All Rights Reserved.</p>
            <br>`,
...
let DohstAmazonsmp = {
    ...
    content: {
        ...
        "mods": [['name', 'description', 'version', 'link', 'required'], 
            ...
            ['BetterF3', "BetterF3 is a mod that replaces Minecraft's original debug HUD with a highly customizable, more human-readable HUD.", '17.0.0', 'https://modrinth.com/mod/betterf3/version/17.0.0', 'client', true], 
            ['Better Advancements', 'Better Advancements tries to improve the UI and UX for the advancements system in minecraft 1.12+ in a modded environment.', '0.4.8.54', 'https://modrinth.com/mod/better-advancements/version/8im6QWDT', 'client', true], 
            ...
            ['Floodgate fabric', 'Hybrid mode plugin to allow for connections from Geyser to join online mode servers.', '2.2.6-b60', 'https://modrinth.com/mod/floodgate/version/81EuNxeZ', 'server'],
            ...
            ['Litematica', 'A client-side schematic mod with extra features for creative mode work', '0.26.5', 'https://modrinth.com/mod/litematica/version/0.26.5', 'client', true], 
            ...
            ['MaLiLib', "A library mod for client-side mods. Contains most of the common/shared code of masa's client mods, and adds some inter-operation support between the dependent mods.", '0.27.9', 'https://modrinth.com/mod/malilib/version/0.27.9', 'client', true], 
            ['MiniHUD', "A 'mini F3' HUD mod, also with various overlays like light level, spawn chunks, slime chunks etc.", '0.38.7', 'https://modrinth.com/mod/minihud/version/0.38.7', 'client', true], 
            ['Mod Menu', 'Adds a mod menu to view the list of mods you have installed.', '17.0.0', 'https://modrinth.com/mod/modmenu/version/17.0.0', 'client', true], 
            ...
            ['Open Parties and Claims', `Adds the ability to claim chunks and make player parties, integrates with Xaero's Minimap and World Map.`, '0.26.2', 'https://modrinth.com/mod/open-parties-and-claims/version/fabric-1.21.11-0.26.2', 'server', true],
            ...
            ['ReplayMod', 'A Minecraft Mod to record, relive and share your experience.', '2.6.26', 'https://modrinth.com/mod/replaymod/version/1.21.11-2.6.26', 'client', true], 
            ...
            ['Servux', 'Servux is a server-side mod that provides support for some client-side mods, such as sending structure bounding boxes for MiniHUD', '0.9.3', 'https://modrinth.com/mod/servux/version/0.9.3', 'server'], 
            ['Simple Voice Chat', 'A working voice chat in Minecraft.', '2.6.16', 'https://modrinth.com/plugin/simple-voice-chat/version/fabric-1.21.11-2.6.16', 'both', true], 
            ['Sodium', 'The fastest and most compatible rendering optimization mod for Minecraft. Now available for both NeoForge and Fabric!', '0.8.11', 'https://modrinth.com/mod/sodium/version/mc1.21.11-0.8.11-fabric', 'client', true], 
            ['ViaBackwards', 'Allow older Java Edition clients to connect to newer servers.', '5.9.0', 'https://modrinth.com/plugin/viabackwards/version/5.9.0', 'server'],
            ['ViaFabric', 'Allows to connect to older servers with older versions.', '0.4.21+158', 'https://modrinth.com/mod/viafabric/version/0.4.21+158-1.14-1.21', 'both', false],
            ['ViaVersion', 'Allow newer Java Edition clients to connect to older servers.', '5.9.0', 'https://modrinth.com/plugin/viaversion/version/5.9.0', 'server'],
            ["Xaero's Minimap", "Displays a map of the nearby world terrain, players, mobs, entities in the corner of your screen. Lets you create waypoints which help you find the locations you've marked.", '25.3.12', 'https://modrinth.com/mod/xaeros-minimap/version/fabric-1.21.11-25.3.12', 'client', true], 
            ["Xaero's World Map", "Adds a full screen world map which shows you what you have explored in the world. Works great together with Xaero's Minimap.", '1.40.16', 'https://modrinth.com/mod/xaeros-world-map/version/fabric-1.21.11-1.40.16', 'client', true], 
        ],
        // 20260327
        "datapacks": [['name', 'description', 'author', 'link'], 
            ...
            ["BlazeandCave's Advancements Pack", 'Adds over 900 new advancements to your Minecraft world', '<a href="https://modrinth.com/user/Cavinator1">Cavinator1</a>', 'https://modrinth.com/datapack/blazeandcaves-advancements-pack/version/1.20.2'], 
            ...
            ['dohst enhancements', 'Makes netherite uncraftable (not after 2026/04/02), makes armor trim recipes cheaper, increases the build height in the nether, and more.', `<a href="${dohst23['link']}">Dohst</a>`, 'dohst.html#datapacks'],
    ...
    set_information: function (text_information = ``) {

        for (let k = 2; k < this.content["information"].length; k++) {
            /* <h2 id="seasons-header">Seasons</h2>
            <section id="seasons">seasons</section> */
            text_information += `<h2 id="${this.content["information"][k][0]}-header">${this.content["information"][k][1]}</h2><section id="${this.content["information"][k][0]}">`;
            console.log("hi")
            
            for (let j = 2; j < this.content["information"][k].length; j++) {
                text_information += `<h3>${this.content["information"][k][j][0]}</h3>`;

                for (let i = 1; i < this.content["information"][k][j].length; i++) {
                    text_information += `<p>${this.content["information"][k][j][i]}</p>`

                };
            };
            text_information += `</section>`
    ...
    set_amazonsmp: function (options = "all", targets = [2, "about", "seasons", "mods", "players", "proxy", "downloads"]) {
        ...
        for (let i = 0; i < options.length; i++) {
            if (options[i] == last) {
                ...
                text_seasons += this.set_seasons_description();
                document.getElementById(targets[2]).innerHTML = text_seasons;
            } else if (options[i] == "downloads") {
                text_downloads += this.set_downloads();
                document.getElementById(targets[6]).innerHTML = text_downloads;
            } else if (options[i] == "about") {
                document.getElementById(targets[1]).innerHTML = text_about;
            } else if (options[i] == "information") {
                text_information = this.set_information()
