...
- #### 1.5.0dev (22/01/2025) beta
    - updated Change log
    - updated readme file
    - updated padding for address text 
    - updated seasons table season 12 information
    - updated mods table and information 
    - updated datapacks table and information 
    - updated all footers to include copyright information
    - made other credit information be in a list on information page
    - removed copyright information from information page
    - added a version 1.5 section on changes page
    - updated future updates section on changes page
    - updated navbar options for information page
    - renamed issues section to report on information page
    - removed idk option from navbar of mandoeam page
    - updated 404 error page

- #### 1.5.1 (02/03/2025 - 02/03/2025) release
    - updated Change log
    - updated readme file
    - removed all old season downloads
    - added downloads for all seasons
    - added information folder
    - moved changes.html to information folder
    - moved information.html to information folder 
    - renamed information.html to credit.html
    - moved website version info from credit.html to footer
    - removed report section from credit.html
    - added a sidebar to credit.html
    - added links to other information files to sidebar for all information pages
    - added a report link to sidebar of information pages
    ...
    - added season 8 information page
    - added season 9 part 1 information page
    - added season 9 part 2 information page
    - added season 10 part 1 information page
    - added season 10 part 2 information page
    - added season 11 part 1 information page
    - added new downloads for all seasons
    - updated download instructions on main information page
    - updated report section on main information page
    - updated added credit for main amazonsmp image on main information page
    - updated credit headings on main information page
    - added season 11 part 2 information page
    - added "full downloads" that arent in multiple parts incase i can get gihub LFS to work
    - updated 404 error page with new pages
    - added rules information page
    - added all seasons assets to images/seasons folder
    - commented everything to do with the fragmented downloads of s7, s9p1, s9p2, s10p1, s10p2, s11p1, s11p2
    - added all download links and sizes onto main page
    - updated update plan and dates
    - updated readme 
    - updated main page datapaks (not full)
    - (Note v1.5.1 - lots of issues, fix all in v1.5.2 before 20250420)
    - remvoed all large files ("full" season downloads for s7 s9p1 s9p2 s10p1 s10p2 s11p1 s11p2, and images as7_map and as10p2 map)
    - added a 1:2 version of the season 7 and season 10 part 2 maps
